/* date = March 31, 2025 7:05 PM */

/**
 * @file RS-FEC.h
 * @brief Implements a Reed-Solomon telemetry encoding scheme - NOT MINE
 * @version 0.1
 *
 *
 *
...
struct Poly {
    Poly()
        : length(0), _id(0), _size(0), _offset(0), _memory(nullptr) {
    }
...
private:
    ...
    bool FindErrorLocator(const Poly *synd, Poly *erase_loc = nullptr, size_t erase_count = 0) {
